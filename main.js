...
function horoscope() {
	...
	for(i = 0; i < zodiac.length; i++) {
		if(sign === zodiac[i].sign) {
			document.getElementById("yourSign").style.color = "White";
			document.getElementById("yourSign").innerHTML = zodiac[i].sign
			document.getElementById("icon").src = zodiac[i].image
			document.getElementById("yourHoroscope").style.color = "White";
			document.getElementById("yourHoroscope").innerHTML = "You're best attributes are: " + zodiac[i].fortune
			return
		} else {
			document.getElementById("yourSign").style.color = "#ff0000";
			document.getElementById("yourSign").innerHTML = "Try again!"
			document.getElementById("yourHoroscope").innerHTML = ""
			document.getElementById("icon").src = zodiac[i].imageTA
